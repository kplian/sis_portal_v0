...
/**
*@package pXP
*@file gen-MODPaginaContenido.php
*@author  (admin)
*@date 03-04-2016 17:58:58
*@description Clase que envia los parametros requeridos a la Base de datos para la ejecucion de las funciones, y que recibe la respuesta del resultado de la ejecucion de las mismas
*/

class MODPaginaContenido extends MODbase{
	...
	function listarPaginaContenido(){
		...
		$this->procedimiento='por.ft_pagina_contenido_sel';
		$this->transaccion='POR_PAGCON_SEL';
		$this->tipo_procedimiento='SEL';//tipo de transaccion
				
		//Definicion de la lista del resultado del query
		$this->captura('id_pagina_contenido','int4');
	...
	function insertarPaginaContenido(){
		...
		try {
			...
			$this->procedimiento='por.ft_pagina_contenido_ime';
			$this->transaccion='POR_PAGCON_INS';
			...
			$configuraciones  = $this->verConfiguracion('PaginaContenido');
	...
	function modificarPaginaContenido(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='por.ft_pagina_contenido_ime';
		$this->transaccion='POR_PAGCON_MOD';
		$this->tipo_procedimiento='IME';
				
		//Define los parametros para la funcion
		$this->setParametro('id_pagina_contenido','id_pagina_contenido','int4');
		$this->setParametro('ruta_archivo','ruta_archivo','varchar');
		$this->setParametro('estado_reg','estado_reg','varchar');
		$this->setParametro('nombre_archivo','nombre_archivo','varchar');
	...
	function eliminarPaginaContenido(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='por.ft_pagina_contenido_ime';
		$this->transaccion='POR_PAGCON_ELI';
		$this->tipo_procedimiento='IME';
