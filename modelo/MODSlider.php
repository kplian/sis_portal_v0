...
class MODSlider extends MODbase{
	...
	function listarSlider(){
		...
		$this->procedimiento='por.ft_slider_sel';
		$this->transaccion='POR_SLID_SEL';
		$this->tipo_procedimiento='SEL';//tipo de transaccion
				
		//Definicion de la lista del resultado del query
		$this->captura('id_slider','int4');
		$this->captura('extension','varchar');
		$this->captura('estado_reg','varchar');
		$this->captura('url_original','varchar');
	...
	function insertarSlider(){
		...
		try {
			...
			$this->procedimiento='por.ft_slider_ime';
			$this->transaccion='POR_SLID_INS';
			...
			$this->setParametro('url_original','url_original','varchar');
			$this->setParametro('url_mediano','url_mediano','varchar');
			...
			$configuraciones  = $this->verConfiguracion('Slider');
	...
	function modificarSlider(){
		//Definicion de variables para ejecucion del procedimiento
		$this->procedimiento='por.ft_slider_ime';
		$this->transaccion='POR_SLID_MOD';
		$this->tipo_procedimiento='IME';
				
		//Define los parametros para la funcion
		$this->setParametro('id_slider','id_slider','int4');
		$this->setParametro('extension','extension','varchar');
		$this->setParametro('url_pequeño','url_pequeño','varchar');
		$this->setParametro('estado_reg','estado_reg','varchar');
		$this->setParametro('url_original','url_original','varchar');
